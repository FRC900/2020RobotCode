...
class SparkMaxCIParams
{
	public:
		SparkMaxCIParams(void)
		  ...
		  , pidf_output_min_{-1}
		  , pidf_output_max_{1}
		  , pidf_reference_ctrl_{hardware_interface::kDutyCycle}
		  , pidf_arb_feed_forward_{0}
		  , pidf_arb_feed_forward_units_{hardware_interface::ArbFFUnits::kVoltage}
		  , pidf_reference_slot_(0)
		  , forward_limit_switch_polarity_(hardware_interface::kNormallyOpen)
		  , forward_limit_switch_enabled_(false)
		  , reverse_limit_switch_polarity_(hardware_interface::kNormallyOpen)
		  ...
		  , idle_mode_(hardware_interface::kCoast)
		...
		// PID Controller
		std::array<double,                          hardware_interface::SPARK_MAX_PID_SLOTS> p_gain_;
		std::array<double,                          hardware_interface::SPARK_MAX_PID_SLOTS> i_gain_;
		std::array<double,                          hardware_interface::SPARK_MAX_PID_SLOTS> d_gain_;
		std::array<double,                          hardware_interface::SPARK_MAX_PID_SLOTS> f_gain_;
		std::array<double,                          hardware_interface::SPARK_MAX_PID_SLOTS> i_zone_;
		std::array<double,                          hardware_interface::SPARK_MAX_PID_SLOTS> d_filter_;
		std::array<double,                          hardware_interface::SPARK_MAX_PID_SLOTS> pidf_output_min_;
		std::array<double,                          hardware_interface::SPARK_MAX_PID_SLOTS> pidf_output_max_;
		std::array<hardware_interface::ControlType, hardware_interface::SPARK_MAX_PID_SLOTS> pidf_reference_ctrl_;
		std::array<double,                          hardware_interface::SPARK_MAX_PID_SLOTS> pidf_arb_feed_forward_;
		std::array<hardware_interface::ArbFFUnits,  hardware_interface::SPARK_MAX_PID_SLOTS> pidf_arb_feed_forward_units_;
		size_t                                                                               pidf_reference_slot_;


		// Forward and Reverse Limit switches
		hardware_interface::LimitSwitchPolarity forward_limit_switch_polarity_;
		bool                                    forward_limit_switch_enabled_;
		hardware_interface::LimitSwitchPolarity reverse_limit_switch_polarity_;
		...
		hardware_interface::IdleMode idle_mode_;
