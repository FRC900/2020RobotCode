	...
	switch(contour_type_id) {
      ...
      positions_.push_back(Point3f(.1778, 1.011936, 2.2098));
		...
		case RED_TAPE_CORNER:
			...
			positions_.push_back(Point3f(.762,5.65404,0));
			positions_.push_back(Point3f(15.221204,5.80644,0));
		...
		case BLUE_TAPE_CORNER:
			...
			positions_.push_back(Point3f(0.762,2.40436,0));
			positions_.push_back(Point3f(15.221204,2.556764,0));
      ...
      break;
		case CONTROL_PANEL_LIGHT:
			...
			positions_.push_back(Point3f(6.88975,6.85165,1.003));
			positions_.push_back(Point3f(9.09828,1.3716,1.003));
			break;
      ...
      break;
		case RED_SHIELD_GENERATOR_LIGHT:
			...
			positions_.push_back(Point3f(10.103993,3.230245,2.39395));
			break;
		case BLUE_SHIELD_GENERATOR_LIGHT:
			...
			positions_.push_back(Point3f(5.879719,4.980305,2.39395));
			break;
      ...
      positions_.push_back(Point3f(10.103993,3.230245,2.39395));
		...
		case SHIELD_GENERATOR_BACKSTOP:
			...
			positions_.push_back(Point3f(10.753852,4.1459912,2.220722));
			positions_.push_back(Point3f(7.241286,5.8960512,2.220722));
			positions_.push_back(Point3f(8.741918,2.314498,2.220722));
			positions_.push_back(Point3f(5.230368,4.0645588,2.220722));
			break;
		case SHIELD_GENERATOR_FIRST_LOGO:
			...
			positions_.push_back(Point3f(8.17702,1.867912,2.67335));
			positions_.push_back(Point3f(9.480042,2.406904,2.67335));
			positions_.push_back(Point3f(5.795264,2.853944,2.67335));
			positions_.push_back(Point3f(5.256276,4.156964,2.67335));
			positions_.push_back(Point3f(6.503162,5.803646,2.67335));
			positions_.push_back(Point3f(7.806182,6.342634,2.67335));
			positions_.push_back(Point3f(10.188956,5.356606,2.67335));
			positions_.push_back(Point3f(10.727944,4.053586,2.67335));
		case SHIELD_GENERATOR_YELLOW_STRIPE:
			height_ = .5334;
			width_ = .508;
			depth_ = 0;
			name_ = "shield_generator_yellow_stripe";
			positions_.push_back(Point3f(8.86333,1.583182,2.54635));
			positions_.push_back(Point3f(9.195308,1.720596,2.54635));
			positions_.push_back(Point3f(5.1089306,3.138678,2.54635));
			positions_.push_back(Point3f(4.971542,3.4706306,2.54635));
			positions_.push_back(Point3f(6.787896,6.4899794,2.54635));
			positions_.push_back(Point3f(7.119874,6.627368,2.54635));
			positions_.push_back(Point3f(10.8752894,5.071872,2.54635));
			positions_.push_back(Point3f(11.012678,4.739894,2.54635));
			break;
		...
		case RED_BLUE_BLACK_SHIELD_GENERATOR_FLOOR_INTERSECTION:
			...
			positions_.push_back(Point3f(5.879719,4.980305,0));
			positions_.push_back(Point3f(10.103993,3.230245,0));
			break;
		case BLUE_BLACK_SHIELD_GENERATOR_FLOOR_INTERSECTION:
			height_ = 0;
			// no object dimensions
			name_ = "blue_black_shield_generator_floor_intersection";
			positions_.push_back(Point3f(6.986143,2.36093,0));
			break;
		case RED_BLACK_SHIELD_GENERATOR_FLOOR_INTERSECTION:
			height_ = 0;
			// no object dimensions
			name_ = "red_black_shield_generator_floor_intersection";
			positions_.push_back(Point3f(8.997569,5.84962,0));
			break;
		case RED_SHIELD_PILLAR_INTERSECTION:
			height_ = 0;
			// no object dimensions
			name_ = "red_shield_pillar_intersection";
			positions_.push_back(Point3f(11.10996,4.97459,0));
			positions_.push_back(Point3f(6.885178,6.72465,0));
			break;
		case BLUE_SHIELD_PILLAR_INTERSECTION:
			height_ = 0;
			// no object dimensions
			name_ = "blue_shield_pillar_intersection";
			positions_.push_back(Point3f(9.098026,1.4859,0));
			positions_.push_back(Point3f(4.87426,3.23596,0));
			break;
		case CONTROL_PANEL:
			height_ = 0.05;
			width_ = 0.81;
			depth_ = 0.81;
			name_ = "control_panel";
			positions_.push_back(Point3f(9.26465,.70485,0.9144));
			positions_.push_back(Point3f(6.7183,7.5057,0.9144));
			break;
		case DS_NUMBERS:
			//needs dimensions
			name_ = "ds_numbers";
			positions_.push_back(Point3f(15.79245,7.220712,1.9304));
			positions_.push_back(Point3f(15.98298,4.964557,1.9304));
			positions_.push_back(Point3f(15.98298,3.550793,1.9304));
			positions_.push_back(Point3f(15.79245,0.989838,1.9304));
			positions_.push_back(Point3f(.1905,7.220712,1.9304));
			positions_.push_back(Point3f(0,4.65963,1.9304));
			positions_.push_back(Point3f(0,3.245993,1.9304));
			positions_.push_back(Point3f(0.1905,0.989838,1.9304));
			break;
		default:
