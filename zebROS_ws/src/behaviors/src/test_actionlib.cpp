...
int main (int argc, char **argv)
{
	...
	if(what_to_run.length() == 0)
	{
		...
		ROS_ERROR("Possible values for run: all, indexer, intake_cargo, outtake_cargo, intake_hatch_panel, outtake_hatch_panel, elevator, climber0, climber1, climber2, climber3, shooter");
