	...
	: ddr_(n)
{
	...
	ddr_.registerVariable<double>("led_channela_output", getLEDOutput(hardware_interface::canifier::LEDChannel::LEDChannelA), boost::bind(&CANifierCIParams::setLEDOutput, this, hardware_interface::canifier::LEDChannel::LEDChannelA, _1, false), "LED Channel A output", 0.0, 1.0);
	ddr_.registerVariable<double>("led_channelb_output", getLEDOutput(hardware_interface::canifier::LEDChannel::LEDChannelB), boost::bind(&CANifierCIParams::setLEDOutput, this, hardware_interface::canifier::LEDChannel::LEDChannelB, _1, false), "LED Channel B output", 0.0, 1.0);
	ddr_.registerVariable<double>("led_channelc_output", getLEDOutput(hardware_interface::canifier::LEDChannel::LEDChannelC), boost::bind(&CANifierCIParams::setLEDOutput, this, hardware_interface::canifier::LEDChannel::LEDChannelC, _1, false), "LED Channel C output", 0.0, 1.0);
	ddr_.registerVariable<bool>("quadidx_output_enable", getGeneralPinOutputEnable(hardware_interface::canifier::GeneralPin::QUAD_IDX), boost::bind(&CANifierCIParams::setGeneralPinOutputEnable, this, hardware_interface::canifier::GeneralPin::QUAD_IDX, _1, false), "General Pins QUAD_IDX output enable");
	ddr_.registerVariable<bool>("quadb_output_enable", getGeneralPinOutputEnable(hardware_interface::canifier::GeneralPin::QUAD_B), boost::bind(&CANifierCIParams::setGeneralPinOutputEnable, this, hardware_interface::canifier::GeneralPin::QUAD_B, _1, false), "General Pins QUAD_B output enable");
	ddr_.registerVariable<bool>("quada_output_enable", getGeneralPinOutputEnable(hardware_interface::canifier::GeneralPin::QUAD_A), boost::bind(&CANifierCIParams::setGeneralPinOutputEnable, this, hardware_interface::canifier::GeneralPin::QUAD_A, _1, false), "General Pins QUAD_A output enable");
	ddr_.registerVariable<bool>("limr_output_enable", getGeneralPinOutputEnable(hardware_interface::canifier::GeneralPin::LIMR), boost::bind(&CANifierCIParams::setGeneralPinOutputEnable, this, hardware_interface::canifier::GeneralPin::LIMR, _1, false), "General Pins limr output enable");
	ddr_.registerVariable<bool>("limf_output_enable", getGeneralPinOutputEnable(hardware_interface::canifier::GeneralPin::LIMF), boost::bind(&CANifierCIParams::setGeneralPinOutputEnable, this, hardware_interface::canifier::GeneralPin::LIMF, _1, false), "General Pins limf output enable");
	ddr_.registerVariable<bool>("sda_output_enable", getGeneralPinOutputEnable(hardware_interface::canifier::GeneralPin::SDA), boost::bind(&CANifierCIParams::setGeneralPinOutputEnable, this, hardware_interface::canifier::GeneralPin::SDA, _1, false), "General Pins SDA output enable");
	ddr_.registerVariable<bool>("scl_output_enable", getGeneralPinOutputEnable(hardware_interface::canifier::GeneralPin::SCL), boost::bind(&CANifierCIParams::setGeneralPinOutputEnable, this, hardware_interface::canifier::GeneralPin::SCL, _1, false), "General Pins SCL output enable");
	ddr_.registerVariable<bool>("spics_output_enable", getGeneralPinOutputEnable(hardware_interface::canifier::GeneralPin::SPI_CS), boost::bind(&CANifierCIParams::setGeneralPinOutputEnable, this, hardware_interface::canifier::GeneralPin::SPI_CS, _1, false), "General Pins SPI_CS output enable");
	ddr_.registerVariable<bool>("spimisopwm2p_output_enable", getGeneralPinOutputEnable(hardware_interface::canifier::GeneralPin::SPI_MISO_PWM2P), boost::bind(&CANifierCIParams::setGeneralPinOutputEnable, this, hardware_interface::canifier::GeneralPin::SPI_MISO_PWM2P, _1, false), "General Pins SPI?MISO_PWM2P output enable");
	ddr_.registerVariable<bool>("spimosipwm1p_output_enable", getGeneralPinOutputEnable(hardware_interface::canifier::GeneralPin::SPI_MOSI_PWM1P), boost::bind(&CANifierCIParams::setGeneralPinOutputEnable, this, hardware_interface::canifier::GeneralPin::SPI_MOSI_PWM1P, _1, false), "General Pins SCL output enable");
	ddr_.registerVariable<bool>("spiclkpwm0p_output_enable", getGeneralPinOutputEnable(hardware_interface::canifier::GeneralPin::SPI_CLK_PWM0P), boost::bind(&CANifierCIParams::setGeneralPinOutputEnable, this, hardware_interface::canifier::GeneralPin::SPI_CLK_PWM0P, _1, false), "General Pins SCL output enable");
	ddr_.registerVariable<bool>("quadidx_output", getGeneralPinOutput(hardware_interface::canifier::GeneralPin::QUAD_IDX), boost::bind(&CANifierCIParams::setGeneralPinOutput, this, hardware_interface::canifier::GeneralPin::QUAD_IDX, _1, false), "General Pins QUAD_IDX output ");
	ddr_.registerVariable<bool>("quadb_output", getGeneralPinOutput(hardware_interface::canifier::GeneralPin::QUAD_B), boost::bind(&CANifierCIParams::setGeneralPinOutput, this, hardware_interface::canifier::GeneralPin::QUAD_B, _1, false), "General Pins QUAD_B output ");
	ddr_.registerVariable<bool>("quada_output", getGeneralPinOutput(hardware_interface::canifier::GeneralPin::QUAD_A), boost::bind(&CANifierCIParams::setGeneralPinOutput, this, hardware_interface::canifier::GeneralPin::QUAD_A, _1, false), "General Pins QUAD_A output ");
	ddr_.registerVariable<bool>("limr_output", getGeneralPinOutput(hardware_interface::canifier::GeneralPin::LIMR), boost::bind(&CANifierCIParams::setGeneralPinOutput, this, hardware_interface::canifier::GeneralPin::LIMR, _1, false), "General Pins limr output ");
	ddr_.registerVariable<bool>("limf_output", getGeneralPinOutput(hardware_interface::canifier::GeneralPin::LIMF), boost::bind(&CANifierCIParams::setGeneralPinOutput, this, hardware_interface::canifier::GeneralPin::LIMF, _1, false), "General Pins limf output ");
	ddr_.registerVariable<bool>("sda_output", getGeneralPinOutput(hardware_interface::canifier::GeneralPin::SDA), boost::bind(&CANifierCIParams::setGeneralPinOutput, this, hardware_interface::canifier::GeneralPin::SDA, _1, false), "General Pins SDA output ");
	ddr_.registerVariable<bool>("scl_output", getGeneralPinOutput(hardware_interface::canifier::GeneralPin::SCL), boost::bind(&CANifierCIParams::setGeneralPinOutput, this, hardware_interface::canifier::GeneralPin::SCL, _1, false), "General Pins SCL output ");
	ddr_.registerVariable<bool>("spics_output", getGeneralPinOutput(hardware_interface::canifier::GeneralPin::SPI_CS), boost::bind(&CANifierCIParams::setGeneralPinOutput, this, hardware_interface::canifier::GeneralPin::SPI_CS, _1, false), "General Pins SPI_CS output ");
	ddr_.registerVariable<bool>("spimisopwm2p_output", getGeneralPinOutput(hardware_interface::canifier::GeneralPin::SPI_MISO_PWM2P), boost::bind(&CANifierCIParams::setGeneralPinOutput, this, hardware_interface::canifier::GeneralPin::SPI_MISO_PWM2P, _1, false), "General Pins SPI?MISO_PWM2P output ");
	ddr_.registerVariable<bool>("spimosipwm1p_output", getGeneralPinOutput(hardware_interface::canifier::GeneralPin::SPI_MOSI_PWM1P), boost::bind(&CANifierCIParams::setGeneralPinOutput, this, hardware_interface::canifier::GeneralPin::SPI_MOSI_PWM1P, _1, false), "General Pins SCL output ");
	ddr_.registerVariable<bool>("spiclkpwm0p_output", getGeneralPinOutput(hardware_interface::canifier::GeneralPin::SPI_CLK_PWM0P), boost::bind(&CANifierCIParams::setGeneralPinOutput, this, hardware_interface::canifier::GeneralPin::SPI_CLK_PWM0P, _1, false), "General Pins SCL output ");

	ddr_.registerEnumVariable<int>("velocity_measurment_period", static_cast<int>(getVelocityMeasurementPeriod()), boost::bind(&CANifierCIParams::setVelocityMeasurementPeriod, this, _1, false), "Velocity Measurement Period", velocity_measurement_period_enum_map_);
	ddr_.registerVariable<int>("velocity_measurement_window_",  getVelocityMeasurementWindow(), boost::bind(&CANifierCIParams::setVelocityMeasurementWindow, this, _1, false), "Velocity measurement window (samples)", 0, 512);

	ddr_.registerVariable<bool>("clear_position_on_limit_f_", getClearPositionOnLimitF(), boost::bind(&CANifierCIParams::setClearPositionOnLimitF, this, _1, false), "Clear position when forward limit switch hit");
	ddr_.registerVariable<bool>("clear_position_on_limit_r_", getClearPositionOnLimitR(), boost::bind(&CANifierCIParams::setClearPositionOnLimitR, this, _1, false), "Clear position when reverse limit switch hit");
	...
	ddr_.registerVariable<int>("status_3_pwminputs0_period", getStatusFramePeriod(hardware_interface::canifier::CANifierStatusFrame::CANifierStatusFrame_Status_3_PwmInputs0), boost::bind(&CANifierCIParams::setStatusFramePeriod, this, hardware_interface::canifier::CANifierStatusFrame::CANifierStatusFrame_Status_3_PwmInputs0, _1, false), "Status 3 PWM inputs 0 frame period", 0, 255);
	ddr_.registerVariable<int>("status_4_pwminputs1_period", getStatusFramePeriod(hardware_interface::canifier::CANifierStatusFrame::CANifierStatusFrame_Status_4_PwmInputs1), boost::bind(&CANifierCIParams::setStatusFramePeriod, this, hardware_interface::canifier::CANifierStatusFrame::CANifierStatusFrame_Status_4_PwmInputs1, _1, false), "Status 4 PWM inputs 1 frame period", 0, 255);
	ddr_.registerVariable<int>("status_5_pwminputs2_period", getStatusFramePeriod(hardware_interface::canifier::CANifierStatusFrame::CANifierStatusFrame_Status_5_PwmInputs2), boost::bind(&CANifierCIParams::setStatusFramePeriod, this, hardware_interface::canifier::CANifierStatusFrame::CANifierStatusFrame_Status_5_PwmInputs2, _1, false), "Status 5 PWM inputs 2 frame period", 0, 255);
	ddr_.registerVariable<int>("status_6_pwminputs3_period", getStatusFramePeriod(hardware_interface::canifier::CANifierStatusFrame::CANifierStatusFrame_Status_6_PwmInputs3), boost::bind(&CANifierCIParams::setStatusFramePeriod, this, hardware_interface::canifier::CANifierStatusFrame::CANifierStatusFrame_Status_6_PwmInputs3, _1, false), "Status 6 PWM inputs 3 frame period", 0, 255);
	ddr_.registerVariable<int>("status_8_misc_period", getStatusFramePeriod(hardware_interface::canifier::CANifierStatusFrame::CANifierStatusFrame_Status_8_Misc), boost::bind(&CANifierCIParams::setStatusFramePeriod, this, hardware_interface::canifier::CANifierStatusFrame::CANifierStatusFrame_Status_8_Misc, _1, false), "Status 8 PWM misc frame period", 0, 255);

	ddr_.registerVariable<int>("control_1_general_period", getControlFramePeriod(hardware_interface::canifier::CANifierControlFrame::CANifier_Control_1_General), boost::bind(&CANifierCIParams::setControlFramePeriod, this, hardware_interface::canifier::CANifierControlFrame::CANifier_Control_1_General, _1, false), "Control 1 general frame period", 0, 255);
	ddr_.registerVariable<int>("control_2_pwm_output_period", getControlFramePeriod(hardware_interface::canifier::CANifierControlFrame::CANifier_Control_2_PwmOutput), boost::bind(&CANifierCIParams::setControlFramePeriod, this, hardware_interface::canifier::CANifierControlFrame::CANifier_Control_2_PwmOutput, _1, false), "Control 1 general frame period", 0, 255);
