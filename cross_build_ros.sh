...
touch .rosinstall
wstool merge ../noetic-ros_comm-wet.rosinstall
wstool update -j8
...
# docker run -it --user ubuntu -v /home/kjaget/2020RobotCode:/home/ubuntu/2020RobotCode -v ~/noetic_arm_cross_ws:/home/ubuntu/noetic_arm_cross_ws  frc900/zebros-2020-dev /bin/bash

# Then run the following from inside the container :

cd ~/noetic_arm_cross_ws
# Do a fresh build - kill off any lingering dependencies
rm -rf ~/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/opt/ros/noetic devel_isolated build_isolated

#catkin config --install --install-space $HOME/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/opt/ros/noetic 
...
./src/catkin/bin/catkin_make_isolated --install --use-ninja -DCMAKE_INSTALL_PREFIX=$HOME/wpilib/2020/roborio/arm-frc2020-linux-gnueabi/opt/ros/noetic -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE=~/2020RobotCode/zebROS_ws/rostoolchain.cmake -DCATKIN_ENABLE_TESTING=OFF
...
tar -cf ~/2020RobotCode/roscore_roborio.tar opt/ros/noetic
bzip2 -9 ~/2020RobotCode/roscore_roborio.tar

# !!!NOTE!!! - important - copy roscore_noetic_roborio.tar.bz2 into the docker repo
